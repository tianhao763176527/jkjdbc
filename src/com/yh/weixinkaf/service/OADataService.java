...
public class OADataService {
	...
	public void  getCheckInData(String accessToken,CheckIn checkIn){
		...
		if (null != jsonObject) {  
			if (0 != jsonObject.getInteger("errcode")) {
				log.error("获取打卡数据 errcode:{} errmsg:{}", jsonObject.getInteger("errcode"), jsonObject.getString("errmsg"));  
			}  
		}  
	...
	public void  getApproveData(String accessToken,Approve approve){
		...
		if (null != jsonObject) {  
			if (0 != jsonObject.getInteger("errcode")) {  
				log.error("获取审批数据 errcode:{} errmsg:{}", jsonObject.getInteger("errcode"), jsonObject.getString("errmsg"));  
			}  
		}  
