...
import com.yh.weixinkaf.pojo.Department;
import com.yh.weixinkaf.test.DepartmentTest;
	...
	public void createDepartment(String accessToken,Department department) {
		...
		if (null != jsonObject) {  
			if (0 != jsonObject.getInteger("errcode")) {  
				...
				log.error("创建部门失败 errcode:{} errmsg:{}", jsonObject.getInteger("errcode"), jsonObject.getString("errmsg"));  
			}  
		}  
	}
