...
<script src="web/WEB-INF/js/jquery-1.10.2.js"></script>
<script src="web/WEB-INF/js/jquery.timers.js"></script>
<script src="web/WEB-INF/js/highchart/highcharts.js"></script>
<script src="web/WEB-INF/js/highchart/modules/exporting.js"></script>
<script src="web/WEB-INF/js/highchart/modules/oldie.js"></script>
<script src="web/WEB-INF/js/pageloader.js"></script>
<link href="web/WEB-INF/css/pageloader.css" rel="stylesheet">
<!--加载 -->
...
<script>
     ...
     basePath = "<%=basePath%>";
     langType = '<%=response.getLocale().toString()%>';
     //定时执行
     function everyTimeOp(time,fun){
         $(this).everyTime(time,fun);
     }
     //定时执行
     function oneTimeOp(time,fu){
         $('body').oneTime(time,fu);
     }
     //停止执行定时
     function stopTimeOp(){
         $('body').stopTime();
